...
import main.bg.softuni.io.commands.contracts.Executable;
...
public class CommandInterpreter implements Interpreter {
    ...
    private final static String COMMANDS_LOCATION = "src/main/bg/softuni/io/commands";
    ...
    private Executable parseCommand(String input, String[] data, String command) {
        File commadsFolder = new File(COMMANDS_LOCATION);
        Executable executable = null;

        for (File file : commadsFolder.listFiles()) {
